...
/** App Stage extends the shared contract with teacher-extension metadata. */
export interface Stage extends DslStage {
  /** Teacher classrooms use the teacher display route and separate history. */
  teacherMode?: boolean;
}
