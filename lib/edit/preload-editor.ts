 ...
 *   2. `surfaces/slide` and `surfaces/interactive` — register the editable
 *      SceneEditorSurfaces into `sceneEditorRegistry` so EditShell can resolve
 *      them (otherwise it falls back to NOOP_SURFACE, i.e. a read-only flash).
 *
